...
contract WebCrawler {
    ...
    string public startUrl = "https://openai.com/";
    ...
    function getCrawledData() public view returns (string memory) {
        return crawledData;
    }

    // Function to get the trained data
    function getTrainedData() public view returns (string memory) {
	    return trainedData;
	}
}